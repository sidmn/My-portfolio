export const navItems = [
  ...
  export const gridItems = [
    ...
    {
      id: 2,
      title: "Flexible with time zones and open to relocation.",
      description: "",
    ...
    {
      id: 5,
      title: "Currently learning React Js and Next Js in more depth",
    ...
    {
      id: 6,
      title: "Enjoyed exploring my portfolio? Let's connect!",
      description: "",
      className: "lg:col-span-2 md:col-span-3 md:row-span-1",
      imgClassName: "",
  ...
  export const workExperience = [
    {
      ...
      listitems: ["Managed data sorting, cleaning, and analysis tasks to ensure accurate and reliable datasets.",
        ...
        "Conducted market research to identify business growth opportunities, contributing to the company's development strategy."
      ]
    },
    {
  ...
  export const socialMedia = [
    {
      id: 1,
      img: "/git.svg",
      link: "https://github.com/sidmn",
    },
    {
      id: 2,
      img: "/link.svg",
      link: "https://www.linkedin.com/in/siddharth-mantri-webdev/"
    },
  ];